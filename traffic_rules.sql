...
INSERT INTO TEST_RESULT_ANSWERS_FACTS (TEST_ID, STUDENT_ID, QUESTION_ID, ANSWER_ID, IS_CORRECT, DATETIME) VALUES (1, 4, 7, 5, 0, DateTime('now'));
...
SELECT count(*) FROM TEST_RESULT_ANSWERS_FACTS traf WHERE traf.STUDENT_ID = 4




SELECT SUM(IS_CORRECT) AS CORRECTLY_ANSWERED,
  COUNT(*)
FROM TEST_RESULT_ANSWERS_FACTS traf
WHERE traf.STUDENT_ID = 4
UNION
SELECT COUNT(DISTINCT QUESTION_ID) FROM TEST WHERE ID = 1
